...
export async function Carousel() {
  const products = await getCollectionProducts({ collection: 'beta' });
        ...
        <ul className="flex animate-carouselx gap-4 xl:animate-carousely xl:flex-col">
          {carouselProducts.map((product, i) => (
            <li
              ...
              className="relative aspect-square h-[30vh] max-h-[275px] w-2/3 max-w-[475px] flex-none md:w-1/3 xl:w-full xl:max-w-full"
            >
